...
import { QUOTE_VALIDATION, NAME_VALIDATION, YEAR_VALIDATION, CLIENT_TYPE_VALIDATION, IMAGE_VALIDATION } from '../../common/ErrorMessageCommom';
import { ImagePlus, Eye, Trash2 } from "lucide-react";
import { ourExportsData } from '../../data/ourexport';

const AddEditOurExperts = () => {
    ...
    const testimonialData = ourExportsData.find(
    ...
    const HandleValidation = Yup.object().shape({
        ...
        year: Yup.mixed().required(YEAR_VALIDATION),
                    ...
                    {({ values, setFieldValue, isSubmitting }) =>
                        <Form>
                            <div className="flex items-center justify-between">
                                <h6 className="text-20 font-semibold text-g1">{id ? "Edit" : "Add"} Exports</h6>
                                <div className='flex items-center space-x-3'>
                                    <Link to="../our-experts" className='btn_secondary w-auto '>Back</Link>
                            ...
                            <div className="flex flex-wrap items-start -mx-1.5 xl:-mx-2.5 2xl:-mx-3.5">
                                ...
                                <div className="w-full md:w-1/3 p-1.5 xl:p-2.5 2xl:p-3.5 relative">
                                    <label className="label">Year <span className='text-red '>*</span></label>
                                    <Field type="text" className="input" name="year" placeholder="Enter Year" />
...
export default AddEditOurExperts