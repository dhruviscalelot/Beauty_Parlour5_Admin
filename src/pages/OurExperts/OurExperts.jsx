...
import { ourExportsData } from '../../data/ourexport.js';
...
const OurExperts = () => {
    ...
    const columns = [
        ...
        { key: "year", label: "Year", renderCell: (key, row) => row?.year || "-" },
    ...
    const paginatedData = ourExportsData.slice(
    ...
    useEffect(() => {
        dispatch(setPageName("Our Exports"))
    }, []);
    ...
    const DeleteOpenDialog = (rowData) => {
        setCommonData({
            ...
            description: "Are You Sure You Want To Delete This Experts? ",
        ...
        <>
            <div className="bg-white rounded-xl lg:rounded-2xl main_shadow p-3 lg:p-4 xl:p-5 space-y-4 lg:space-y-6 xl:space-y-8">
                ...
                <div className="flex items-center justify-between">
                    <h6 className="text-20 font-semibold text-primary">All Experts</h6>
                ...
                <CustomTable
                    ...
                    data={paginatedData}
                    isPagination={true}
                    totalRecords={ourExportsData.length}
