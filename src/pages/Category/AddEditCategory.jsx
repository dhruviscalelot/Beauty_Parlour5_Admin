...
import { IMAGE_VALIDATION, SUBTITLE_VALIDATION, TITLE_VALIDATION,DESCRIPTION_VALIDATION } from '../../common/ErrorMessageCommom';
...
const AddEditCategory = () => {
  ...
  const initialValues = {
    ...
    subtitle: serviceData?.mainSubtitle || "",
  ...
  const HandleValidation = Yup.object().shape({
    ...
    subtitle: Yup.string().required(SUBTITLE_VALIDATION),
            ...
            <Form>
              <div className="flex items-center justify-between">
                ...
                <div className='flex items-center space-x-3'>
                  <Link to="../category" className='btn_secondary w-auto '>Back</Link>
              ...
              <div className="flex flex-wrap items-start -mx-1.5 xl:-mx-2.5 2xl:-mx-3.5">
                ...
                <div className="w-full md:w-1/2 p-1.5 xl:p-2.5 2xl:p-3.5 relative">
                  <label className="label">Sub Title <span className='text-red '>*</span></label>
                  <Field type="text" className="input" name="subtitle" placeholder="Enter Sub Title" />
                  <ErrorMessage name="subtitle" component="span" className="error" />
                </div>
                ...
                <div className="w-full p-1.5 xl:p-2.5 2xl:p-3.5 relative">
                  ...
                  <Field as="textarea" name="description" className="input h-[130px] py-3" placeholder="Enter Customer Quote/Review" />
